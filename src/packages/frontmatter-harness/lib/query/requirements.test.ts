...
describe('requirementsForRule', () => {
  ...
  describe('failure cases', () => {
    it('leaves an unwritten unknownKeys absent rather than spelling it allowed', () => {
      ...
      // ARRANGE
      const rule: FrontmatterRule = { ruleId: 'r', intent: 'i', folders: ['docs/'], fields: {} };
      // ACT
      const actual = requirementsForRule(rule);
      // ASSERT
    ...
    it('gives a forbidden rule no fields key at all', () => {
      // ARRANGE
      const rule: FrontmatterRule = { ruleId: 'r', intent: 'i', folders: ['docs/'], frontmatter: 'forbidden' };
      // ACT
      const actual = requirementsForRule(rule);
      // ASSERT
  ...
  describe('edge cases', () => {
    ...
    it('carries only the set constraints the Operator wrote', () => {
      // ARRANGE
      const rule: FrontmatterRule = { ruleId: 'r', intent: 'i', folders: ['docs/'], anyOf: ['a', 'b'] };
    ...
    it('keeps an explicitly written unknownKeys', () => {
      ...
      const rule: FrontmatterRule = { ruleId: 'r', intent: 'i', folders: ['docs/'], unknownKeys: 'forbidden' };
      // ACT
      const actual = requirementsForRule(rule);
      // ASSERT
