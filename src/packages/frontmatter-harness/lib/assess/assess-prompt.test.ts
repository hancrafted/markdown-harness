...
import type { AssessConditions, FrontmatterRule } from '../../section.types.ts';
...
const bare: FrontmatterRule = { ruleId: 'research', intent: 'Research is indexed', folderTrees: ['docs/research/'] };
